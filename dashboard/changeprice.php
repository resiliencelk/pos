...
<div id="main-container">
    ...
    <div class="row-container">
      ...
      <table width="99%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" style="border:1px solid #d9e1e8; border-radius:5px 5px 0px 0px; color:#333;">
        <tr style="background:url(../images/table-bg.jpg); background-repeat:repeat-x; height:30px;">
          ...
          <th width="17%" align="center"><div class="table-heading">Catagory</div></th>
          <th width="17%" align="center"><div class="table-heading">Brand</div></th>
          <th width="15%" align="center"><div class="table-heading">Model</div></th>
          <th width="17%" align="center"><div class="table-heading">Item Name</div></th>
          <?php
				/*if(isset($_SESSION['uertype']) and $_SESSION['uertype']=="A")
				{*/
			?>
          <th width="12%" align="center"><div class="table-heading">Unit Price</div></th>
          <?php
				/*}*/
		  ?>
          <th align="center" width="8%"><div class="table-heading">Quantity</div></th>
          <th width="12%" align="center"><div class="table-heading">Sales Price </div></th>
          <th width="10%" align="center"><div class="table-heading">Action</div></th>
        </tr>
        ...
        <tr class="border">
            ...
            <td align="center">
            	<input type="submit" name="editdetails" value="" class="setting-btn" />
            </td>
