...
<div id="main-container">
    ...
    <div class="row-container">
      ...
      <table width="100%" cellpadding="5" cellspacing="0" border="0" bgcolor="#FFFFFF" style="border-radius:5px 5px 0px 0px; color:#333;">
        <tr style="background:url(../images/table-bg.jpg); background-repeat:repeat-x; height:30px;">
          ...
          <?php
				...
				{*/
			?>
          <th width="15%" align="center"><div class="table-heading">Unit Price</div></th>
          <?php
				/*}*/
		  ?>
          <th align="center"><div class="table-heading">Quantity</div></th>
          <th width="16%" align="center"><div class="table-heading">Sales Price </div></th>
          <th width="13%" align="center"><div class="table-heading">Warrenty</div></th>
        ...
        <tr class="border">
            ...
            <?php
				...
				{*/
			?>
            <td align="center" style="color:#06F;">
