    ...
    <div class="row-container">
        ...
        <div id="right-column">
        	<div class="main-text-container">
                ...
                <a href="sales-invoice.php" class="system-item-box"><img src="../images/invoice/sales.png" width="100%" style="border-radius:5px;"/></a>
                <a href="sales-invoice.php" class="system-item-box"><img src="../images/invoice/service.png" width="100%" style="border-radius:5px;"/></a>
                <a href="sales-invoice.php" class="system-item-box"><img src="../images/invoice/sales.png" width="100%" style="border-radius:5px;"/></a>
                <a href="sales-invoice.php" class="system-item-box"><img src="../images/invoice/sales.png" width="100%" style="border-radius:5px;"/></a>
                <a href="sales-invoice.php" class="system-item-box"><img src="../images/invoice/sales.png" width="100%" style="border-radius:5px;"/></a>
              	</div>
