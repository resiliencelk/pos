...
if(isset($_POST['deleteitem'])){
	...
	//echo "DELETE FROM _invoiceitems WHERE id='$invid' AND invoiceid='$invid'";
	$dabasehandle->_invisibleRecordInsertion("DELETE FROM _invoiceitems WHERE id='$itmid' AND invoiceid='$invid'");
}
?>
    			...
    			<!-- end of message row !-->
                    ...
                    <div class="row-container" style="margin-top:20px;">
                        ...
                        <tr>
                          ...
                          <td><input type="text" name="salesprice" value="" style="text-align:right;" onblur="cal_total();"/></td>
                          <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="85%" align="left"><input type="text" name="totalprice" value="" width="60%" style="text-align:right;"/></td>
                                <td width="15%" align="right"><input type="submit" name="saveitems" value=""width="35%" class="addbutton" title="Add Record"/></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                        ...
                        <tr class="border">
                            ...
                            <td>
                            	<form name="deleteinvoice" method="post" action="service-invoice.php">
                                    <input type="hidden" name="itmid" value="<?php echo $invoiceditemdatas['id']; ?>" />
