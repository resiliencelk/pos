    ...
    <!-- 2nd row !-->
        ...
        <!-- start of system-right-column!-->
            ...
            <div class="row-container" >
                ...
                <input style="width:87%; padding:2px 0px 2px 0px;" type="hidden" name="oldthumbimage"placeholder="60px * 40px"  value="<?php if(isset($_POST['itemtype'])||isset($_POST['brand'])||isset($_POST['supplierid'])){if(isset($_POST['oldthumbimage'])){echo $_POST['oldthumbimage'];}}elseif(isset($_GET['itemid'])){echo $dabasehandle->_getInfo("SELECT thumbimage FROM _items WHERE itemid='".$_GET['itemid']."'","thumbimage");}?>" />
...
<span class="selectRequiredMsg">Please select an item.</span></span>
    ...
    <div class="row-container" style="margin-top:20px;">
        <table width="100%" cellpadding="1px" cellspacing="0" border="0" bgcolor="#FFFFFF" style="border:1px solid #d9e1e8; border-radius:5px 5px 0px 0px; color:#333;">
