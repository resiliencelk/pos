...
<div id="main-container">
    ...
    <div class="row-container" style="margin-top:20px;">
        ...
        <table width="100%" cellpadding="1px" cellspacing="0" border="0" bordercolor="#CCCCCC" style="border:1px solid #d9e1e8; border-radius:5px 5px 0px 0px; color:#333;">
        ...
        <table width="100%" cellpadding="1px" cellspacing="0" border="0" bordercolor="" style="border:1px solid #d9e1e8; border-radius:5px 5px 0px 0px; color:#333;">
          <tr style="background:url(../images/table-bg.jpg); background-repeat:repeat-x; height:30px;">
